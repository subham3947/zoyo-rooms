...
insert into ROOM(ROOM_ID,AVAILABLE,CAPACITY,HOTEL_ID,PRICE)values (65, true, 1, 1234, 650);
insert into ROOM(ROOM_ID,AVAILABLE,CAPACITY,HOTEL_ID,PRICE)values (66, true, 2, 1234, 850);
insert into ROOM(ROOM_ID,AVAILABLE,CAPACITY,HOTEL_ID,PRICE)values (67, true, 4, 1234, 1250);
insert into ROOM(ROOM_ID,AVAILABLE,CAPACITY,HOTEL_ID,PRICE)values (68, true, 1, 9101, 600);
insert into ROOM(ROOM_ID,AVAILABLE,CAPACITY,HOTEL_ID,PRICE)values (69, true, 2, 5678, 600);
...
insert into RESERVATION(RESERVATION_ID,HOTEL_ID,CHECK_IN,CHECK_OUT,ROOM_ID,USER_ID)values (5636,1234,'2021-05-12','2021-05-14',65,21);
